...
public class MyTextView extends android.support.v7.widget.AppCompatEditText {
    ...
    private void init(AttributeSet attrs) {
        if(attrs!=null) {
            ...
            // 捕捉焦点后，下划线的初始颜色
            preLineColor = array.getColor(R.styleable.MyTextView_preLineColor, getResources().getColor(R.color.colorBlackThree));
            // 标签文字的颜色
            labelColor = array.getColor(R.styleable.MyTextView_labelColor, getResources().getColor(R.color.colorBlackThree));
            // 标签文字的内容
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 根据标签的高度比例绘制标签文字
        canvas.drawText(labelText, getScrollX(),(getScrollY()-dpToPix(1)+extraTopPadding)*yFraction, textPaint);
        // 绘制下划线
    ...
    private void correctPaddings() {
        ...
        super.setPadding(getPaddingLeft(),getPaddingTop()+extraTopPadding,getPaddingRight(),getPaddingBottom()+extraBottomPadding+dpToPix(20));
